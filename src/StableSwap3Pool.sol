...
contract StableSwap3Pool is ERC20, ReentrancyGuard, Ownable {
    ...
    // Events
    event TokenSwap(address indexed buyer, uint256 sold_id, uint256 tokens_sold, uint256 bought_id, uint256 tokens_bought);
    ...
    constructor(IERC20[N_COINS] memory _coins, uint256 _A, uint256 _fee, uint256 _admin_fee) ERC20("Curve.fi DAI/USDC/USDT", "3CRV") Ownable(msg.sender) {
    ...
    */
     ...
     */
     ...
     function _getY(uint256 i, uint256 j,uint256 x, uint256[N_COINS] memory _balances ) internal view returns (uint256 y) {
